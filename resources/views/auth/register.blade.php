...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-10">
            <div class="auth-header" style="font-family: 'Sofia', sans-serif;">{{ __('Register your account ') }} </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group row">
                    <div class="offset-md-3 col-md-6">
                        <select  class="rounded-form form-control @error('user_type') is-invalid @enderror" name="user_type"  id="user_type">
                ...
                <div class="form-group row">
                    ...
                    <div class="offset-md-3 col-md-6">
                        <select  class="rounded-form form-control @error('name') is-invalid @enderror" name="country"  id="country">
                ...
                <div class="form-group row">
                    <div class="offset-md-3 col-md-6">
                        <input id="postal_code" type="text" placeholder="Postal code"  class="rounded-form form-control @error('postal_code') is-invalid @enderror" name="postal_code" value="{{ old('postal_code') }}" required autocomplete="postal_code" autofocus>
                ...
                <div class="form-group row mb-0">
                    <div class="offset-md-3 col-md-6 d-flex justify-content-center w-100 mt-2">
                        <a href=" {{ url('login') }}">I already have account</a>
                    </div>
                </div>
